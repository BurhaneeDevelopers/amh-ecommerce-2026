    ...
    return (
        <footer className="bg-[#272727]">
            <Container className="">
                    ...
                    <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:col-span-2 lg:grid-cols-4">
                        <div>
                            ...
                            <ul className="mt-6 space-y-4 text-sm">
                                ...
                                <li>
                                    <a href="#" className="text-white transition hover:opacity-75"> Delivery Information </a>
                                </li>
                                ...
                                <li>
                                    <a href="#" className="text-white transition hover:opacity-75"> T&C </a>
                                </li>
                ...
                <P className="text-gray-200 pt-4 !bg-[#272727]/70 w-full text-center">&copy; 2025. MSI Industries. All rights reserved.</P>
            </Container>
        </footer>
    )
}

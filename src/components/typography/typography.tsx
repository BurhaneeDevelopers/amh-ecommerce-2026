...
export const H5: React.FC<Props> = ({ className, children }) => (
    <h5 className={cn("scroll-m-20 text-xl font-semibold tracking-tight", className)}>
        {children}
    </h5>
);

export const H6: React.FC<Props> = ({ className, children }) => (
    <h6 className={cn("scroll-m-20 text-lg font-semibold tracking-tight", className)}>
        {children}
    </h6>
);
...
export const Li: React.FC<Props> = ({ className, children }) => (
    <li className={cn("text-xl list-none", className)}>
        {children}
    </li>
);

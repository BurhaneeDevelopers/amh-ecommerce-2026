...
import { useGetFeaturedTestimonials } from '@/api/testimonials.service'
                ...
                <div className="animate-pulse">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        {Array.from({ length: 3 }).map((_, index) => (
                            <div key={index} className="bg-gray-100 rounded-lg p-6 h-64"></div>
                        ))}
                    </div>
                </div>
            </Container>
            ...
            <div className="mt-7">
                <div className="relative overflow-hidden min-h-[300px]">
                    ...
                    >
                        ...
                        {Array.from({ length: itemsPerPage - currentTestimonials.length }).map((_, index) => (

...
const LatestProducts = () => {
    ...
    const getResponsiveConfig = useCallback(() => {
        if (typeof window !== 'undefined') {
            ...
            if (width < 640) return { itemsPerRow: 2, rows: 1 }; // mobile: 2x1
            if (width < 768) return { itemsPerRow: 2, rows: 2 }; // tablet: 2x2  
            if (width < 1024) return { itemsPerRow: 3, rows: 2 }; // small desktop: 3x2
            return { itemsPerRow: 4, rows: 2 }; // large desktop: 4x2
        }
        ...
        <Container className='!px-0'>
            ...
            <div className="mt-7">
                ...
                <div 
                    ...
                    style={{ 
                        minHeight: config.rows === 1 ? '350px' : '640px' // Fixed heights based on rows (increased for 2 cards)
                    }}
                >
                    <motion.div
                        key={currentPage}
